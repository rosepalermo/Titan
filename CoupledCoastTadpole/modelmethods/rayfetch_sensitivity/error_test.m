...
% subplot(2,1,1)
ax1 = axes(h);
plot(ax1,delta,1-(sum_warea_delta./sum_warea_delta(1)),'k','LineWidth',2)
xlabel('delta')
...
ax2 = axes(h);
% subplot(2,1,2)
plot(ax2, 360./nrays,1-(sum_warea./sum_warea(end)),'r','LineWidth',2)
xlabel('angle between rays (\delta \phi)')
