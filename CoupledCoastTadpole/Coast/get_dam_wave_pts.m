function [dam_matrix,wave_weight_matrix,fetch_matrix,indshoreline_ordered,cells2trash,p] = get_dam_wave_pts(lake,p,X,Y)
...
[warea,farea,wpiws,wpjws,rayazimuths,coastazimuths,fpis,fpjs] = GetFetchArea_pts(indshoreline_ocw,F_lake,p.nrays,p.delta,p.dx);    
clearvars erodedind
    %         end
