...
load('example_800x800_beta1_6_V2.mat')
output = solution;
% 1 m contour at t = 1
figure()
...
grid
x_0_5m_t1v2 = contourxy_sorted{1,1}(1,:);
y_0_5m_t1v2 = contourxy_sorted{1,1}(2,:);
...
set(gca,'Ydir','reverse')
grid
x_0_5m_t3v2 = contourxy_sorted{1,1}(1,:);
y_0_5m_t3v2 = contourxy_sorted{1,1}(2,:);
...
x_0_5m_t2v2 = out{1,1}(1,:);
y_0_5m_t2v2 = out{1,1}(2,:);


save('xy_beta1_6_v2.mat','x_0_5m_t1v2','y_0_5m_t1v2','x_0_5m_t2v2','y_0_5m_t2v2','x_0_5m_t3v2','y_0_5m_t3v2')
