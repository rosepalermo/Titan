...
save_on = false;
i=1;
addpath('/Volumes/GoogleDrive/My Drive/Titan/github/Cellular Damage Model')
for ii = 6
    i = ii;
    
    clearvars -except period global_Save i save_on eq14save
...
%     [period{i},eq14holder] = dowave_aa(theta,deltad,n,x,y,savename,save_on,fetch,i);
    ...
    % hold on
    % scatter(x,y,'.','k')close close aclclose all
