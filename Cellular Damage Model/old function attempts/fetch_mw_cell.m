function [WaveArea] = fetch_wavefield_cell(shoreline_fetch)
%THIS FUNCTION IS A PREVIOUS VERSION OF FETCH_WAVEFIELD_CELL. THE UPDATES
%IN THE NEW FUNCTION INCLUDE WEIGHTING THE WAVEAREA FIELD TO BE A FUNCTION OF THE CALCULATED
%FETCH.
