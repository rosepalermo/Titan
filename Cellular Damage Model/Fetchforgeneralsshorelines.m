...
A(5).cord{1,1}(:,1) = X(sub2ind(size(X),sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)));
A(5).cord{1,1}(:,2) = Y(sub2ind(size(X),sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)));

figure(); plot(X(sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)),Y(sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)))
...
save('waveandfetch_4generalssls_u30.mat','A','WaveArea_save','FetchArea_save')