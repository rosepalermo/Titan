...
% t1v1 _ REDNOISE
SL_matrix(1).cord{1,1}(:,1) = ordered_sl_save{runsplot(1),1}{1,1}(:,1);
SL_matrix(1).cord{1,1}(:,2) = ordered_sl_save{runsplot(1),1}{1,1}(:,2);
...
shoreline = addidshoreline_cardonly(lake_save{runsplot(2),1},~lake_save{runsplot(ii),1});
...
shoreline = addidshoreline_cardonly(lake_save{runsplot(3),1},~lake_save{runsplot(ii),1});
[sl_cell,cells2trash] = order_cw_lastpoint(lake_save{runsplot(3),1},shoreline);
SL_matrix(6).cord{1,1}(:,1) = X(sub2ind(size(X),sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)));
SL_matrix(6).cord{1,1}(:,2) = Y(sub2ind(size(X),sl_cell{1,1}(:,1),sl_cell{1,1}(:,2)));
...
% t1v1 _ REDNOISE
SL_matrix(7).cord{1,1}(:,1) = ordered_sl_save{runsplot(1),1}{1,1}(:,1);
SL_matrix(7).cord{1,1}(:,2) = ordered_sl_save{runsplot(1),1}{1,1}(:,2);
...
% t1v1 _ wavet30
SL_matrix(8).cord{1,1}(:,1) = ordered_sl_save{runsplot(2),1}{1,1}(:,1);
SL_matrix(8).cord{1,1}(:,2) = ordered_sl_save{runsplot(2),1}{1,1}(:,2);

% t1v1 _ wavet50
SL_matrix(9).cord{1,1}(:,1) = ordered_sl_save{runsplot(3),1}{1,1}(:,1);
SL_matrix(9).cord{1,1}(:,2) = ordered_sl_save{runsplot(3),1}{1,1}(:,2);
