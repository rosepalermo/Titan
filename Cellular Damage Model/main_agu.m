...
% 2 = REDNOISE
savename{1} = 'D:\Titan\Modeling\AGU final folder\model output\rednoise_v1_'; 
% 3 = WAVE t1v1_30
savename{2} = 'D:\Titan\Modeling\AGU final folder\model output\wave_t1v1_30_'; 
% 3 = WAVE t1v1_50
savename{3} = 'D:\Titan\Modeling\AGU final folder\model output\wave_t1v1_50_';
% 5 = UNIFORM t1v1_30
savename{4} = 'D:\Titan\Modeling\AGU final folder\model output\uniform_t1v1_30_'; 
% 5 = UNIFORM t1v1_50
savename{5} = 'D:\Titan\Modeling\AGU final folder\model output\uniform_t1v1_50_'; 
% 4 = RIVERS t3v1
savename{6} = 'D:\Titan\Modeling\AGU final folder\model output\river_t3v1_'; 
% 6 = Lake Powell
savename{7} = 'D:\Titan\Modeling\AGU final folder\model output\LakePowell_'; 
% 7 = Scotland
savename{8} = 'D:\Titan\Modeling\AGU final folder\model output\scotland_'; 
% 9 = LGM
savename{9} = 'D:\Titan\Modeling\AGU final folder\model output\lgm'; 
fetch = [];
if save_on
savename = savename{i};
end
