...
%         saveas(gcf,['C:\Users\Rose Palermo\Documents\Titan\Modeling\6_17_pregeneralsfigs\','wave_rednoise',num2str(i),'.fig'])
        ...
        saveas(gcf,['C:\Users\Rose Palermo\Documents\Titan\Modeling\11_18_riverandwave_higherstrength\',savename,num2str(i),'.fig'])
    end
...
if fetch_on
    if save_on
        ...
        save(['C:\Users\Rose Palermo\Documents\Titan\Modeling\11_18_riverandwave_higherstrength\',savename,'.mat'],'shoreline_save','ordered_sl_save','dam_save','corners_save','damcorners_save','X','Y')
        
    end
else
    save(['C:\Users\Rose Palermo\Documents\Titan\Modeling\11_18_riverandwave_higherstrength\',savename,'.mat'],'shoreline_save','dam_save','X','Y','lake_save')
end
%% plot
eroded = eroded(2:end,:);
